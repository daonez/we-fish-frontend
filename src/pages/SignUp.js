                ...
                {this.state.popup14checker === false ? (
                  ...
                  <div className="popup14div">
                    <div>
                      ...
                      <br />
                      <p>
                        2.정보통신망 이용촉진 및 정보보호 등에 관한 법률에는 만
                        14세 미만 아동의 개인정보 수집 시 법정 대리의 동의를
                        받도록 규정하고 있으며, 생년월일을 허위로 기재하여
                        법정대리인의 동의 없이 회원가입을 하는 경우 회원탈퇴
                        또는 서비스 이용이 제한 될 수 있음을 안내해드립니다
                      </p>
                    </div>
                    <div className="popup14subdiv">
                      <button className="popup14divbtn" onClick={this.popup14}>
                        닫기
                      </button>
                    </div>
                  </div>
