            ...
            <div className="navSideBar">
                <div className="profileLoggedOut">
                    <div className="profileLoggedOut02">
                        ...
                        <p className="registerButton"><a href="/">님</a></p>
                    </div>
                </div>
                <div className="pointBar">
                    <div className="coupon">
                        <p className="coupon1">할인쿠폰</p>
                        <p><span class="coupon2">0 </span><span className="coupon3">장</span></p>
                    </div>
                    <div className="point">
                        <p className="point1">포인트</p>
                        <p><span class="point2">3,000 </span><span className="point3">p</span></p>
                    </div>
                </div>
